...
//   title: "Next.js Profile | DashNextz - Next.js Dashboard",
//   description:
//     "This is Next.js Profile page for DashNextz - Next.js Tailwind CSS Admin Dashboard",
// };
        ...
        <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
            ...
            <div className="mt-4">
              ...
              <p className="font-medium">{session?.user?.isAdmin ? "Admin" : "User"}</p>
